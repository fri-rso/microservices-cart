- C **ikel zvezne integracije(Travis CI ustvari sliko Docker in objavi na Docker Hub)
...
- M **etrics (storitvam dodajte končno točko na kateri izpostavite nekaj metrik)
